...
### 🧑 Обо мне
- **Выпускник курса с проф. переподготовкой от Яндекс.Практикум, имеется опыт навыков на выполнении проектов курса, а также опыт проведения проблемных интервью на коммерческой работе.**
...
- **Python:**
  ...
  - **Визуализация (построение диаграмм).**
